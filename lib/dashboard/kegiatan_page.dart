...
class _KegiatanPageState extends State<KegiatanPage> {
  ...
  final Color softGreenBg = const Color(0xFFF4F7F2);
                  ...
                  : BarChart(
                      BarChartData(
                        ...
                        barGroups: List.generate(12, (i) {
                          ...
                          final total =
                              double.tryParse(bulanData['total'].toString()) ??
                              0;
...
Widget _dashboardSmallCard(
  ...
  const Color kombuGreen = Color(0xFF374426);
    ...
    child: InkWell(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(icon, size: 32, color: kombuGreen),
            const SizedBox(height: 12),
            Text(
              value,
